...
import foodCourtImg from "../assets/Plot.png";
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-[48px] font-bold mb-4">
            <span className="italic text-[#20A4BE]">{propertyTypes.title}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto auto-rows-[220px] md:auto-rows-[250px] grid-flow-dense px-4 md:px-0">
            ...
            return (
              ...
              >
                <div className="relative h-full w-full overflow-hidden">
                  ...
                  />
                  <div className="absolute top-0 left-0 right-0 p-6 text-white bg-gradient-to-b from-black/80 via-black/40 to-transparent">
                    <p className="text-sm mb-2 opacity-90">{type.count}</p>
                    <h3 className="text-2xl font-bold" style={{ fontFamily: 'Poppins', fontWeight: 600, fontSize: '20px', lineHeight: '120%', letterSpacing: '0%', color: '#FFFFFF' }}>{type.name}</h3>
                  </div>
                </div>
              </Card>
            );
